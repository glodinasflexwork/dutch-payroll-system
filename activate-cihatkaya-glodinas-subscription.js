...
async function activateSubscription() {
  try {
    console.log('Activating subscription for cihatkaya@glodinas.nl...')
    ...
    const subscription = await prisma.subscription.upsert({
      ...
      update: {
        ...
        stripeSubscriptionId: 'demo_subscription_cihatkaya_glodinas_' + Date.now(),
        isTrialActive: false,
      ...
      create: {
        ...
        currentPeriodStart: new Date(),
        currentPeriodEnd: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000), // 1 year from now
        stripeCustomerId: 'demo_customer_cihatkaya_glodinas_' + Date.now(),
        stripeSubscriptionId: 'demo_subscription_cihatkaya_glodinas_' + Date.now(),
        isTrialActive: false,
        convertedFromTrial: true,
        trialConvertedAt: new Date()
